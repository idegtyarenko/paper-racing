...
export const be: Strings = {
  ...
  settings: {
    ...
    lapsLabel: 'Колаў',
    lapsHint:
      'Колькі колаў доўжыцца гонка. Адно кола\u00A0— кароткая сутычка, некалькі даюць ' +
      'час адыграцца пасля памылкі.',
  ...
  race: {
    ...
    finalWarn: ' Хто\u00A0перасячэ рысу раней, той і\u00A0наперадзе.',
  ...
  rules: {
    body:
      'Paper Racing\u00A0— гонка па\u00A0клетачках. Намалюй кальцавую трасу і\u00A0абгані на\u00A0ёй сапернікаў.\n\n' +
      ...
      'Пераможа той, хто першым праедзе ўсе\u00A0колы. А\u00A0калі некалькі балідаў фінішуюць на\u00A0адным ходзе\u00A0— наперадзе той, чый балід перасек рысу раней унутры ходу.\n\n' +
      'Надакучыла ехаць? З\u00A0гонкі можна выйсці ў\u00A0любы момант і\u00A0даглядзець яе\u00A0збоку.\n\n' +
      'Паводзіны машыны і\u00A0правілы гонкі можна падладзіць пад сябе, калі траса намалявана,\u00A0— шукай укладкі «Паводзіны» і\u00A0«Правілы».',
  },
