...
const MSG: Record<EditorPhase, string> = {
  outer:
    'Шаг 1 из 5. Нарисуйте ВНЕШНИЙ край трассы: обведите замкнутый контур ' +
    'одним непрерывным движением — мышью или пальцем.',
  inner: 'Шаг 2 из 5. Теперь нарисуйте ВНУТРЕННИЙ край трассы — внутри внешнего.',
  finish:
    'Шаг 3 из 5. Проведите линию старта/финиша поперёк дороги: начните с одной ' +
    'стороны дороги, протяните и отпустите с другой.',
  direction: 'Шаг 4 из 5. Нажмите на одну из зелёных стрелок — в какую сторону ехать.',
  ready: 'Трасса готова! Выберите количество игроков.',
};
